...
public class StatisticServiceTest {
    ...
    private final App mainApp = new App(1L, "ewm-main-service");

    private final StatisticDto statEvent1Ip1 = StatisticDto
            .builder()
            .uri("event/1")
            .ip("1")
            .app(mainApp.getName())
            ...
            .build();
    private final StatisticDto statEvent2Ip1 = StatisticDto
            .builder()
            .uri("event/2")
            .ip("1")
            .app(mainApp.getName())
            ...
            .build();
    private final StatisticDto statEvent6Ip2 = StatisticDto
            .builder()
            .uri("event/1")
            .ip("2")
            .app(mainApp.getName())
            ...
            .build();
    private final StatisticDto statEventIp2 = StatisticDto
            .builder()
            .uri("event/")
            .ip("2")
            .app(mainApp.getName())
            ...
            .build();
    private final LocalDateTime start = LocalDateTime.parse("2000-01-01 11:11:11", GeneralConstants.DATE_FORMATTER);
    private final LocalDateTime end = LocalDateTime.parse("3000-01-01 11:11:11", GeneralConstants.DATE_FORMATTER);
