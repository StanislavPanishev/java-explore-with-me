...
public class StatisticControllerTest {
    ...
    private final StatisticDto addingStatisticForEvent1 = StatisticDto.builder()
            .app(mainApp.getName())
            .uri("/events/1")
            .ip("192.163.0.1")
            .timestamp(LocalDateTime.parse("2023-10-06 22:00:23", GeneralConstants.DATE_FORMATTER))
            .build();
    private final StatisticResponse statsForEvent1 = new StatisticResponse(mainApp, "/events/1", 2L);
